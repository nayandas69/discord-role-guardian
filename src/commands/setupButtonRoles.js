...
export const setupButtonRolesCommand = {
  data: new SlashCommandBuilder()
    ...
    .addChannelOption((option) =>
      option.setName("channel").setDescription("Channel to send the button role message").setRequired(true),
    )
    .addStringOption((option) =>
      option.setName("title").setDescription("Title of the button role embed").setRequired(true),
    )
    .addStringOption((option) =>
      option.setName("description").setDescription("Description for the button role message").setRequired(true),
    )
    .addStringOption((option) =>
      option
        .setName("roles")
        .setDescription("Format: label:roleID:style,label:roleID:style (style: primary/secondary/success/danger)")
        .setRequired(true),
    ),
