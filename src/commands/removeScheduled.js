  ...
  async execute(interaction) {
    try {
      ...
      const embed = {
        ...
        footer: {
          text: timerCancelled ? "Stopped immediately - no restart needed" : "This message will no longer be sent",
        },
      ...
      log.success(`Removed scheduled message "${messageName}" in ${interaction.guild.name} by ${interaction.user.tag}`)
